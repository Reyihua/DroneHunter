...
from .aug_z import DualAttentionFusion
import copy
...
class SiamDTRCNN(TwoStageDetector):
    ...
    def forward_train(self,
        ...
        bbox_feats_z, all_feats_z = self.roi_head.bbox_roi_extractor(
            z[:self.roi_head.bbox_roi_extractor.num_inputs], rois_z) # [:4]
        
        bbox_feats_z = self.aug_z(all_feats_z)
        ...
        bbox_feats_x,_ = self.roi_head.bbox_roi_extractor(
    ...
    def _process_query(self, img_z, gt_bboxes_z, img_meta_z):
        ...
        # get template
        rois_z = bbox2roi(gt_bboxes_z)
        self._bbox_feats_z, all_feats_z = self.roi_head.bbox_roi_extractor(
            z[:self.roi_head.bbox_roi_extractor.num_inputs], rois_z)

        
        self._bbox_feats_z = self.aug_z(all_feats_z)
        ...
        self._bbox_feats_bg,_ = self.roi_head.bbox_roi_extractor(
    ...
    def _process_gallary(self, img_x, img_meta_x, **kwargs):
        ...
        for mm in range(0, Top_NUM):
            ...
            bbox_feats_mm,_ = self.roi_head.bbox_roi_extractor(
