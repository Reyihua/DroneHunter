...
def parse_args():
    ...
    parser.add_argument(
        '--config',
        default='configs/drone_hunter25.py') #siam_encoder_decoder.py
    parser.add_argument(
        '--work_dir',
        default='work_dirs/drone_hunter25')
    parser.add_argument('--load_from',
        default='pretrained_weights/siam_ssm_tiny.pth.tar') #siam_ssm_tiny.pth.tar cascade_mask_rcnn_swin_tiny.pth.tar
    ...
    parser.add_argument(
        ...
        type=str,
        default='uavtir_train'  # uavtir_train / got10k_train / lasot_train antiuav_infrar antiuav_visible
    )
    parser.add_argument(
