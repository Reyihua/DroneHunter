...
__all__ = ['UAVtir_Eval', 'EvaluatorantiUAV', 'EvaluatorUAVtir', 'EvaluatorantiUAVV', 'EvaluatorDUT', 'EvaluatorDT']
...
@registry.register_module
class EvaluatorDUT(UAVtir_Eval):
    ...
    def __init__(self, root_dir=None, subset='test', **kwargs):
        dataset = datasets.DUT(root_dir, subset)
        super(EvaluatorDUT, self).__init__(dataset, **kwargs)
...
class EvaluatorantiUAV(UAVtir_Eval):
    ...
    def __init__(self, root_dir=None, subset='test', **kwargs):
        dataset = datasets.antiUAV(root_dir, subset)
        super(EvaluatorantiUAV, self).__init__(dataset, **kwargs)

@registry.register_module
class EvaluatorantiUAVV(UAVtir_Eval):
    r"""Evaluation pipeline and evaluation toolkit for antiUAV dataset.
    ...
    def __init__(self, root_dir=None, subset='test', **kwargs):
        dataset = datasets.antiUAVV(root_dir, subset)
        super(EvaluatorantiUAVV, self).__init__(dataset, **kwargs)

@registry.register_module
class EvaluatorDT(UAVtir_Eval):
    ...
    def __init__(self, root_dir=None, subset='test', **kwargs):
        dataset = datasets.DT(root_dir, subset)

        super(EvaluatorDT, self).__init__(dataset, **kwargs)
