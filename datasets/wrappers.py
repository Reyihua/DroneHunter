...
def _datasets(name):
    ...
    if name == 'coco_train':
        ...
        return data.UAVtir(root_dir='/root/code/data/', subset='train')
    elif name == 'uavtir_val':
        return data.UAVtir(root_dir='/root/code/data/', subset='val')
    elif name == 'antiuav_infrar':
        return data.antiUAV(root_dir='/root/code/dataset/antiuav/infrared/', subset='train')
    elif name == 'antiuav_visible':
        return data.antiUAV(root_dir='/root/code/dataset/antiuav/visible/', subset='train')
    elif name == 'DUT':
        return data.DUT(root_dir='/root/code/dataset/DUT/', subset='train')
    elif name == 'DT':
        return data.DT(root_dir='/root/code/dataset/DT/', subset='train')
